...
function displayPics() {
  ...
  // The previous line threw an error because when 'let' was changed to 'let' because letiables defined using 'let' are only scoped inside the code block they're defined in. 
  console.log(viewed)
