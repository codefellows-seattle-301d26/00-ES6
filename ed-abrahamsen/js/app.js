...
function displayPics() {
  ...
  // Before I changed the var to let, var was globally scoped. Let is not globaly scoped in any block of code, like the while in this case, where var is only local in a function not all blocks of code. Let is local in all code blocks.
  console.log(viewed)
