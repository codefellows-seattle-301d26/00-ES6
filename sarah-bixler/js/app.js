...
function displayPics() {
  ...
  // var rando, was dependant on being able to renamed, but by calling it let, I created two seperately scoped variables that were unable to communicate with each other.  var rando could not receive the new rando from the while loop.  they both just hung out side by side with out talking. 
  console.log(viewed)
