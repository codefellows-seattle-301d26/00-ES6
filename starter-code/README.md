...
'Const' can be declared globally whereas 'let' can only be used within its code block and does not allow for manipulation outside of that. All the for loops needed to be used with 'let'.
