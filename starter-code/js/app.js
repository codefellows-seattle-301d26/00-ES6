...
function displayPics() {
  ...
  // The previous line threw an error because when 'var' was changed to 'let' because variables defined using 'let' are only scoped inside the code block they're defined in. 
  console.log(viewed)
